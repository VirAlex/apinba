...
buttonresult.addEventListener('click', () => {
  ...
  document.querySelector('#butres').innerHTML = '<a href="#" id="buttonveille"><span>Veille</span></a>';
  let buttonVeille = document.querySelector("#buttonveille")
  buttonVeille.addEventListener('click', () => {
    console.log("Hello");
...
buttonother.addEventListener('click', () => {
  ...
  let buttonresult = document.querySelector('#butres');
  buttonresult.addEventListener('click', () => {
    fetchGameScore();
    ;
  })
